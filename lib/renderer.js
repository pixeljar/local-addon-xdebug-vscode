...
function default_1(context) {
    ...
    hooks.addContent('siteInfoUtilities', (site) => {
        return (react_1.default.createElement(local_components_1.TableListRow, { key: "vscode-xdebug-integration", label: "XDebug + VSCode" },
            ...
            react_1.default.createElement("p", null,
                react_1.default.createElement("small", null, "The run configuration will be added to the VSCode project settings in this site's root directory."))));
    });
}
